...
struct HanddripGuide10: View {
    @State private var downloadAmount10 = 0.0
    @State var nextGuide11 = false
    @State var backGuide7 = false
    @State var toggle = false
    @State var isAppear = false
    let timer10 = Timer.publish(every: 0.001, on: .main, in: .common).autoconnect()
    var body: some View {
                ...
                VStack{
                    ...
                    ZStack{
                        ...
                        VStack{
                            ...
                            HStack{
                                ProgressView(value: downloadAmount10, total: 30000)
...
struct HanddripGuide11_Previews: PreviewProvider {
